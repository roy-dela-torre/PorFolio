jQuery(document).ready(function (d) {
    var l = 2500, t = 3800, r = t - 3e3, n = 50, o = 150, c = 500, h = c + 800, p = 600, e = 1500; function u(s) {
        var i, e, a = m(s); s.parents(".cd-headline").hasClass("type") ? ((i = s.parent(".cd-words-wrapper")).addClass("selected").removeClass("waiting"), setTimeout(function () {
            ...
            i.removeClass("in").addClass("out"); i.is(":last-child") ? a && setTimeout(function () {
                u(m(e))
            }, l) : setTimeout(function () {
                s(i.next(), e, a, n)
            }, n); {
                var t; i.is(":last-child") && d("html").hasClass("no-csstransitions") && (t = m(e), w(e, t))
            }
        ...
        var s = d(this), e = s.text().split(""), a = s.hasClass("is-visible"); for (i in e) 0 < s.parents(".rotate-2").length && (e[i] = "<em>" + e[i] + "</em>"), e[i] = a ? '<i class="in">' + e[i] + "</i>" : "<i>" + e[i] + "</i>"; var n = e.join(""); s.html(n).css("opacity", 1)
    }), function (s) {
        var n = l; s.each(function () {
            var s, i, e, a = d(this); a.hasClass("loading-bar") ? (n = t, setTimeout(function () {
